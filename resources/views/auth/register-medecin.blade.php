    ...
    <p class="mt-1 text-sm text-gray-500">JPG, PNG ou PDF. Max 1MB.</p>
                            ...
                            <div class="mt-1 flex flex-wrap gap-2">
                                <div class="flex items-center">
                                    <input id="langue_francais" name="langues[]" type="checkbox" value="Français"
                                        class="h-4 w-4 text-[#4dabb4] focus:ring-[#4dabb4] border-gray-300 rounded"
                                ...
                                <div class="flex items-center">
                                    ...
                                    <input type="text" name="langues_autre_texte"
                                        class="ml-2 text-sm border-gray-300 focus:border-[#4dabb4] focus:ring focus:ring-[#4dabb4]/20 rounded-md"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-xs text-gray-500">8 caractères minimum, avec lettres et chiffres
                                </p>
                            </div>
                        ...
                        <div class="flex items-center justify-between mt-8">
                            ...
                            <button type="submit"
                                class="group relative flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-[#4dabb4] hover:bg-[#3d8a91] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#4dabb4] transition-colors duration-300">
