    ...
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center space-x-4">
            ...
            <div class="relative">
                ...
                <input type="text" placeholder="Rechercher..." class="pl-10 pr-4 py-1.5 w-48 md:w-64 rounded-lg border border-gray-200 focus:outline-none focus:ring-1 focus:ring-[#b9ff66] focus:border-[#b9ff66] text-sm">
            </div>
