...
<div x-data="{{ json_encode(['show' => true, 'style' => $style, 'message' => $message]) }}"
    :class="{ 'bg-[#4dabb4]': style == 'success', 'bg-red-700': style == 'danger', 'bg-[#b9f362]': style == 'warning', 'bg-gray-500': style != 'success' && style != 'danger' && style != 'warning'}"
            style="display: none;"
            x-show="show && message"
    ...
    <div class="max-w-screen-xl mx-auto py-2 px-3 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between flex-wrap">
            <div class="w-0 flex-1 flex items-center min-w-0">
                <span class="flex p-2 rounded-lg" :class="{ 'bg-[#4dabb4]/80': style == 'success', 'bg-red-600': style == 'danger', 'bg-[#b9f362]/80': style == 'warning' }">
            ...
            <div class="shrink-0 sm:ms-3">
                <button
                    ...
                    :class="{ 'hover:bg-[#4dabb4]/80 focus:bg-[#4dabb4]/80': style == 'success', 'hover:bg-red-600 focus:bg-red-600': style == 'danger', 'hover:bg-[#b9f362]/80 focus:bg-[#b9f362]/80': style == 'warning'}"
                    aria-label="Dismiss"
