    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div class="lg:col-span-9">
            ...
            <div id="section-consultations" class="bg-white rounded-[20px] p-6 shadow-sm hidden">
                <h2 class="text-xl font-bold mb-6">Liste des Consultations</h2>
                <div class="overflow-x-auto">
                    <table class="w-full">
                        <thead class="bg-gray-50 rounded-lg">
                            <tr>
                        ...
                        <tbody class="divide-y divide-gray-200">
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4">15/03/2024 09:30</td>
                    ...
                    <table class="w-full">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                        <button onclick="openViewOrdonnanceModal()" class="text-blue-600 hover:text-blue-800">Voir</button>
        ...
        <form id="ordonnanceForm" class="space-y-6">
            ...
            <div class="bg-gray-50 p-4 rounded-lg space-y-2">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <button type="button"
                            class="bg-[#b9ff66] hover:bg-[#a8eb5f] text-black rounded-full px-4 py-2">
                        Signer
                    </button>
                </div>
            </div>
            ...
            <div class="flex justify-end gap-4 pt-4 border-t">
                <button type="button"
                        onclick="closeNewOrdonnanceModal()"
...
<div id="viewOrdonnanceModal"
    ...
    <div class="bg-white rounded-[20px] p-6 w-full max-w-5xl h-[95vh] mx-4 relative flex flex-col">
        ...
        <div class="flex-1 bg-gray-100 rounded-lg overflow-hidden relative">
            <iframe id="pdfViewer"
                    class="w-full h-full"
                    src="/storage/ordonnances/exemple.pdf#toolbar=0"
...
<div id="newPatientModal"
     class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50">
    <div class="bg-white rounded-[20px] p-8 w-full max-w-4xl mx-4 relative max-h-[90vh] overflow-y-auto shadow-2xl transform transition-all duration-300 ease-in-out">
        <!-- En-tête Modal -->
        <div class="flex justify-between items-center mb-8">
            ...
            <button onclick="closeNewPatientModal()" class="hover:bg-gray-100 p-2 rounded-full transition-all duration-200">
                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/>
                </svg>
            </button>
            ...
            <div class="bg-[#f8fafc] p-6 rounded-[20px] shadow-sm space-y-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        ...
                        <select class="w-full rounded-lg border-gray-300 focus:ring-[#b9ff66] focus:border-[#b9ff66] transition-all duration-200">
